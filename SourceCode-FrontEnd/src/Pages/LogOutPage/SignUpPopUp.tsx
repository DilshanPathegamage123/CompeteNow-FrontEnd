...
import SignUpBackImg1 from "../../assets/Images/SignUp Background Img.png";
import SignUpBackImg2 from "../../assets/Images/SignUp Background Img2.png";
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10">
      <div className="bg-white rounded-lg shadow-lg relative w-3/5 h-auto flex">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${SignUpBackImg2})` }}
        >
          {/* Add Layer mask for the background image */}
          <div
            className="absolute inset-0 bg-cover bg-center opacity-50"
            style={{ backgroundImage: `url(${SignUpBackImg1})` }}
          ></div>
          <div className="relative flex justify-end p-5">
            <button onClick={onClose} className="text-cyan-50 md:hidden">
              <FontAwesomeIcon icon={faTimes} />
            </button>
          </div>
          <div className="">
            <div className="relative flex-grow flex items-center justify-center text-cyan-50 mt-20">
        ...
        <div className="w-full md:w-3/5 column1 relative">
          ...
          <div className="flex flex-col items-center mt-8">
            ...
            <button
              type="button"
              className="w-auto p-1 mb-8 border rounded-md mt-3  flex items-center justify-center  hover:bg-[#b4a8cf]"
            >
              <svg
